...
from app.schemas.app_settings import AppSettingsCreate, AppSettingsRead, AppSettingsUpdate
...
@router.get(
    "", response_model=List[AppSettingsRead], dependencies=[Depends(auth), Depends(permissions(P.AppSettings.READ))]
)
...
async def update_setting(
    setting_id: UUID, dto: AppSettingsUpdate, svc: AppSettingsService = Injected(AppSettingsService)
):
