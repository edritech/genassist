...
async def get_access_token(
    ...
    try:
        ...
        if not client_id or not client_secret:
            raise HTTPException(status_code=500, detail="Gmail credentials not configured in app settings")
...
async def get_user_email(access_token: str) -> str:
    ...
    try:
        ...
        if not user_email:
            ...
            raise HTTPException(status_code=400, detail="Failed to retrieve user email from Gmail profile")
