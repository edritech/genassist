...
def schema_to_transcript_message(
    segment: TranscriptSegmentInput, conversation_id: UUID, sequence_number: int
...
def json_to_transcript_messages(transcript_json: str, conversation_id: UUID) -> List[TranscriptMessageModel]:
    """
