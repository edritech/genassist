...
class RoleModel(Base):
    __tablename__ = "roles"
    __table_args__ = (PrimaryKeyConstraint("id", name="roles_pk"), UniqueConstraint("name", name="roles_unique"))
    ...
    def permissions(self) -> list[str]:
        ...
        """
        return [rp.permission.name for rp in self.role_permissions if rp.permission and rp.permission.is_active]
