...
class Dependencies(Module):
    ...
    @provider
    @singleton
    def provide_socket_connection_manager(self, redis_string: RedisString) -> SocketConnectionManager:
        """
    ...
    def configure(self, binder):
        ...
        binder.bind(
            QuestionAnswerer,
            to=QuestionAnswerer(llm_model=settings.DEFAULT_OPEN_AI_GPT_MODEL, temperature=0.0),
            scope=request_scope,
        )
