...
from .providers import LegraConfig, LightRAGConfig, VectorConfig
...
class AgentRAGConfig(BaseModel):
    ...
    vector_config: Optional[VectorConfig] = Field(default=None, description="Vector system configuration")
    legra_config: Optional[LegraConfig] = Field(default=None, description="LEGRA system configuration")
    lightrag_config: Optional[LightRAGConfig] = Field(default=None, description="LightRAG system configuration")
...
class KbRAGConfig(BaseModel):
    ...
    vector: Optional[Dict[str, Any]] = Field(default=None, description="Vector database configuration")

    # LEGRA configuration
    legra: Optional[Dict[str, Any]] = Field(default=None, description="LEGRA system configuration")

    # LightRAG configuration
    lightrag: Optional[Dict[str, Any]] = Field(default=None, description="LightRAG system configuration")
    ...
    def get_vector_config(self) -> Optional[VectorConfig]:
        ...
        chunking_data = {
            ...
            "keep_separator": vector_data.get(
                "chunk_keep_separator", get_schema_default("vector", "chunk_keep_separator", True)
            ),
            "strip_whitespace": vector_data.get(
                "chunk_strip_whitespace", get_schema_default("vector", "chunk_strip_whitespace", True)
            ),
        }
        ...
        embedding_data = {
            ...
            "model_name": vector_data.get(
                "embedding_model_name", get_schema_default("vector", "embedding_model_name", "all-MiniLM-L6-v2")
            ),
            "model_id": vector_data.get(
                "embedding_model_id", get_schema_default("vector", "embedding_model_id", "amazon.titan-embed-text-v2:0")
            ),
            "region_name": vector_data.get(
                "embedding_region_name", get_schema_default("vector", "embedding_region_name", "ca-central-1")
            ),
            "device": vector_data.get(
                "embedding_device_type", get_schema_default("vector", "embedding_device_type", "cpu")
            ),
            "batch_size": vector_data.get(
                "embedding_batch_size", get_schema_default("vector", "embedding_batch_size", 32)
            ),
            "normalize_embeddings": vector_data.get(
                "embedding_normalize_embeddings", get_schema_default("vector", "embedding_normalize_embeddings", True)
            ),
        ...
        vector_db_data = {
            ...
            "collection_name": vector_data.get(
                "vector_db_collection_name", get_schema_default("vector", "vector_db_collection_name", "")
            ),
        }
    ...
    def get_legra_config(self) -> Optional[LegraConfig]:
        ...
        return LegraConfig(
            ...
            embedding_model=legra_data.get(
                "embedding_model",
                get_schema_default("legra", "embedding_model", "sentence-transformers/all-MiniLM-L6-v2"),
            ),
            ...
            use_gpu=legra_data.get("generation_use_gpu", get_schema_default("legra", "generation_use_gpu", False)),
            max_tokens=legra_data.get(
                "generation_max_tokens", get_schema_default("legra", "generation_max_tokens", 1024)
            ),
            n_neighbors=legra_data.get("graph_n_neighbors", get_schema_default("legra", "graph_n_neighbors", 10)),
            metric=legra_data.get(
                "graph_distance_metric", get_schema_default("legra", "graph_distance_metric", "cosine")
            ),
            min_sents=legra_data.get("chunk_min_sentences", get_schema_default("legra", "chunk_min_sentences", 1)),
            max_sents=legra_data.get("chunk_max_sentences", get_schema_default("legra", "chunk_max_sentences", 30)),
            min_sent_length=legra_data.get(
                "chunk_min_sentence_length", get_schema_default("legra", "chunk_min_sentence_length", 32)
            ),
            working_dir=legra_data.get(
                "storage_working_directory", get_schema_default("legra", "storage_working_directory", None)
            ),
        )
    ...
    def get_lightrag_config(self) -> Optional[LightRAGConfig]:
        ...
        return LightRAGConfig(
            ...
            search_mode=lightrag_data.get("search_mode", get_schema_default("lightrag", "search_mode", "mix")),
            ...
            top_k=lightrag_data.get("top_k", get_schema_default("lightrag", "top_k", 5)),
