...
class SearchResult(BaseModel):
    ...
    chunk_count: Optional[int] = Field(default=None, description="Number of chunks for this result")


class DataProviderInterface(BaseModel):
    """Interface definition for data providers"""

    provider_type: Literal["vector", "legra"] = Field(description="Type of provider")
    enabled: bool = Field(default=False, description="Whether provider is enabled")
    initialized: bool = Field(default=False, description="Whether provider is initialized")
