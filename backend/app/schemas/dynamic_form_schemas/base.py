    ...
    # Flat structure
        ...
        for field_dict in data.get("fields", []):
            ...
            if "conditional" in field_dict:
                ...
                conditional = ConditionalField(field=cond_data["field"], value=cond_data["value"])
...
def convert_schemas_dict_to_typed(
    ...
    return {key: convert_dict_to_type_schema(value) for key, value in schemas_dict.items()}
