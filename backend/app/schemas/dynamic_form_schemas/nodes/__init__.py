...
NODE_HANDLERS_SCHEMAS: Dict[str, List[FieldSchema]] = {
    ...
    "whatsappToolNode": [{"id": "input", "type": "target", "position": "left", "compatibility": "any"}],
    "slackMessageNode": [
        {"id": "input", "type": "target", "position": "left", "compatibility": "any"},
        {"id": "output", "type": "source", "position": "right", "compatibility": "any"},
    ],
    "zendeskTicketNode": [{"id": "input", "type": "target", "position": "left", "compatibility": "text"}],
    "gmailNode": [{"id": "input", "type": "target", "position": "left", "compatibility": "any"}],
    "readMailsNode": [
        {"id": "input", "type": "target", "position": "left", "compatibility": "any"},
        {"id": "output", "type": "source", "position": "right", "compatibility": "any"},
    ],
    ...
    "chatInputNode": [{"id": "output", "type": "source", "position": "right", "compatibility": "any"}],
    "chatOutputNode": [{"id": "input", "type": "target", "position": "left", "compatibility": "any"}],
    "routerNode": [
        {"id": "input", "type": "target", "position": "left", "compatibility": "any"},
