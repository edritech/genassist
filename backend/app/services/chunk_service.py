...
class ChunkService:
    ...
    def fixed_rolling_text_split(
        self, doc_id: str, content: str, chunk_size: Optional[int] = None, overlap_size: Optional[int] = None
    ) -> List[TextChunk]:
        """
    ...
    def sentence_text_split(
        self, doc_id: str, content: str, custom_sentence_endings: Optional[List[str]] = None
    ) -> List[TextChunk]:
        """
    ...
    def custom_text_split(
        self, doc_id: str, content: str, delimiters: List[str], preserve_delimiters: bool = True
    ) -> List[TextChunk]:
        """
    ...
    def semantic_md_document_split(
        self, doc_id: str, content: str, heading_levels: Optional[List[int]] = None, include_headings: bool = True
    ) -> List[TextChunk]:
        """
    ...
    def semantic_html_document_split(
        self, doc_id: str, content: str, tags: List[str], include_opening_tags: bool = False
    ) -> List[TextChunk]:
        """
