...
class LlmProviderService:
    ...
    @cache(expire=300, namespace="llm_providers:get_by_id", key_builder=llm_provider_id_key_builder, coder=PickleCoder)
    ...
    @cache(expire=300, namespace="llm_providers:get_all", key_builder=llm_provider_all_key_builder, coder=PickleCoder)
