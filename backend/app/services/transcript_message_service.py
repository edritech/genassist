...
class TranscriptMessageService:
    def __init__(self, transcript_message_repository: TranscriptMessageRepository):
        self.transcript_message_repo = transcript_message_repository

    async def add_transcript_message_feedback(
        self, message_id: UUID, transcript_feedback: TranscriptSegmentFeedback
    ) -> tuple[MessageFeedbackModel, UUID]:
        ...
        feedback = await self.transcript_message_repo.add_message_feedback(message_id, transcript_feedback)
