    ...
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      <DialogContent className={`sm:max-w-[${maxWidth}] p-0 overflow-hidden`}>
        <form onSubmit={onSubmit}>
          ...
          <div className="px-6 pb-6 space-y-5 max-h-[calc(90vh-160px)] overflow-y-auto">{children}</div>
          ...
          <DialogFooter className="px-6 py-4 border-t">
            <div className="flex justify-end gap-3 w-full">
              ...
              <Button type="submit" disabled={isLoading} className="px-4 bg-blue-600 hover:bg-blue-700">
                {isLoading ? (
                  <>
