...
type LLModelDialogProps = BaseNodeDialogProps<LLMModelNodeData, BaseLLMNodeData>;
...
export const LLModelDialog: React.FC<LLModelDialogProps> = (props) => {
  ...
  return (
    ...
    >
      <ModelConfiguration id="agent-config" config={config} onConfigChange={setConfig} typeSelect="model" />
    </NodeConfigPanel>
  );
};
