...
export const CHAT_INPUT_NODE_DEFINITION: NodeTypeDefinition<ChatInputNodeData> = {
  type: 'chatInputNode',
  label: 'Start',
  description: 'Defines the entry point of the workflow where inputs are received.',
...
export const CHAT_OUTPUT_NODE_DEFINITION: NodeTypeDefinition<ChatOutputNodeData> = {
  type: 'chatOutputNode',
  label: 'Finish',
  description: 'Defines the endpoint of the workflow where final outputs are delivered.',
...
export const SET_STATE_NODE_DEFINITION: NodeTypeDefinition<SetStateNodeData> = {
  type: 'setStateNode',
  label: 'Set State',
  description: 'Sets the value of a stateful parameter that persists across workflow executions.',
  shortDescription: 'Set stateful parameter value',
  configSubtitle: 'Configure which stateful parameter to update and what value to set.',
  category: 'io',
  icon: 'Database',
  defaultData: {
    name: 'Set State',
