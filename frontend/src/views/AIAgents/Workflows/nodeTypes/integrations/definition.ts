...
export const GMAIL_NODE_DEFINITION: NodeTypeDefinition<GmailNodeData> = {
  ...
  configSubtitle: 'Configure email settings, including recipients, subject, and body.',
...
export const ZENDESK_TICKET_NODE_DEFINITION: NodeTypeDefinition<ZendeskTicketNodeData> = {
  ...
  description: 'Creates a new ticket in Zendesk with specified requester and ticket details.',
  shortDescription: 'Create a Zendesk ticket',
  configSubtitle: 'Configure Zendesk ticket fields, including requester details and tags.',
  category: 'integrations',
  icon: 'Zendesk',
  defaultData: {
...
export const SLACK_OUTPUT_NODE_DEFINITION: NodeTypeDefinition<SlackOutputNodeData> = {
  ...
  configSubtitle: 'Configure Slack messaging settings, including channel and message content.',
  category: 'integrations',
  icon: 'Slack',
  defaultData: {
...
export const WHATSAPP_NODE_DEFINITION: NodeTypeDefinition<WhatsappNodeData> = {
  ...
  configSubtitle: 'Configure WhatsApp message settings, including recipient and content.',
  category: 'integrations',
  icon: 'Whatsapp',
  defaultData: {
...
export const READ_MAILS_NODE_DEFINITION: NodeTypeDefinition<ReadMailsNodeData> = {
  type: 'readMailsNode',
  label: 'Email Reader',
  description: 'Retrieves emails using customizable search filters from a connected email account.',
  shortDescription: 'Retrieve emails',
  configSubtitle: 'Configure email search filters, data source, and retrieval parameters.',
  category: 'integrations',
  icon: 'MailOpen',
  defaultData: {
    name: 'Email Reader',
...
export const CALENDAR_EVENT_NODE_DEFINITION: NodeTypeDefinition<CalendarEventToolNodeData> = {
  ...
  description: 'Creates calendar events using extracted or user-provided scheduling details.',
  shortDescription: 'Schedule a calendar event',
  configSubtitle: 'Configure calendar event details, including timing, summary, and data source.',
  category: 'integrations',
  icon: 'Calendar',
  defaultData: {
  ...
  component: CalendarEventNode as React.ComponentType<NodeProps<CalendarEventToolNodeData>>,
  createNode: (id, position, data) => ({
    id,
    type: 'calendarEventNode',
    position,
...
export const JIRA_NODE_DEFINITION: NodeTypeDefinition<JiraNodeData> = {
  ...
  description: 'Creates a new task in a Jira project space with configurable fields and metadata.',
  shortDescription: 'Create a Jira task',
  configSubtitle: 'Configure Jira task settings, including project space, name, and description.',
  category: 'integrations',
  icon: 'Jira',
  defaultData: {
