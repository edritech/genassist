...
import { AggregatorNodeData, NodeData, NodeTypeDefinition, RouterNodeData } from '../../types/nodes';
...
export const ROUTER_NODE_DEFINITION: NodeTypeDefinition<RouterNodeData> = {
  ...
  description: 'Routes data along different branches based on evaluation of a condition.',
  shortDescription: 'Route based on a condition',
  configSubtitle: 'Configure routing conditions, including comparison values and logic.',
  category: 'routing',
  icon: 'SplitRotated',
  defaultData: {
...
export const AGGREGATOR_NODE_DEFINITION: NodeTypeDefinition<AggregatorNodeData> = {
  type: 'aggregatorNode',
  label: 'Result Merger',
  description: 'Merges results from multiple branches and returns once conditions are met.',
  shortDescription: 'Merge results',
  configSubtitle: 'Configure result aggregation settings, including strategy and timeout.',
  category: 'routing',
  icon: 'MergeRotated',
  defaultData: {
    name: 'Result Merger',
