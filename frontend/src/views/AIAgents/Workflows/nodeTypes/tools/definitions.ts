...
export const API_TOOL_NODE_DEFINITION: NodeTypeDefinition<APIToolNodeData> = {
  type: 'apiToolNode',
  label: 'API Connector',
  description: 'Makes HTTP requests to external APIs using configurable methods, headers, and bodies.',
  shortDescription: 'Call an external API',
  configSubtitle: 'Configure API request settings, including endpoint, method, headers, and body.',
  category: 'tools',
  icon: 'Globe',
  defaultData: {
    name: 'API Connector',
...
export const OPEN_API_NODE_DEFINITION: NodeTypeDefinition<OpenApiNodeData> = {
  ...
  description: 'Uses an OpenAPI specification and an LLM to answer questions about an API.',
  shortDescription: 'Explore an API specification',
  configSubtitle: 'Select an LLM provider, upload an OpenAPI spec, and define the query.',
  category: 'tools',
  icon: 'Search',
  defaultData: {
...
export const KNOWLEDGE_BASE_NODE_DEFINITION: NodeTypeDefinition<KnowledgeBaseNodeData> = {
  ...
  description: 'Queries connected knowledge bases to retrieve relevant information.',
  shortDescription: 'Query knowledge bases',
  configSubtitle: 'Configure knowledge base query settings, including selected sources and limits.',
  category: 'tools',
  icon: 'Database',
  defaultData: {
...
export const PYTHON_CODE_NODE_DEFINITION: NodeTypeDefinition<PythonCodeNodeData> = {
  ...
  description: 'Executes Python code to transform data or perform custom logic.',
  shortDescription: 'Execute Python code',
  configSubtitle: 'Configure the Python execution environment, including script and parameters.',
  category: 'tools',
  icon: 'Code',
  defaultData: {
...
export const SQL_NODE_DEFINITION: NodeTypeDefinition<SQLNodeData> = {
  type: 'sqlNode',
  label: 'SQL Executor',
  description: 'Executes SQL queries on a configured database. Write SQL manually or generate it from text.',
  shortDescription: 'Execute SQL queries',
  configSubtitle: 'Configure SQL generation settings, including model provider, data source, and prompts.',
  category: 'tools',
  icon: 'Database',
  defaultData: {
    name: 'SQL Executor',
...
export const WORKFLOW_EXECUTOR_NODE_DEFINITION: NodeTypeDefinition<WorkflowExecutorNodeData> = {
  ...
  description: 'Executes another workflow as a sub-workflow, allowing you to compose workflows together.',
  shortDescription: 'Execute another workflow',
  configSubtitle: 'Select a workflow to execute and configure its input parameters.',
  category: 'tools',
  icon: 'Workflow',
  defaultData: {
