...
import { NodeTypeDefinition, NodeData, TemplateNodeData, DataMapperNodeData } from '../../types/nodes';
...
export const TEMPLATE_NODE_DEFINITION: NodeTypeDefinition<TemplateNodeData> = {
  type: 'templateNode',
  label: 'Text Template',
  description: 'Generates formatted text using a configurable template with dynamic variables.',
...
export const DATA_MAPPER_NODE_DEFINITION: NodeTypeDefinition<DataMapperNodeData> = {
  ...
  description: 'Transforms data using mapping rules or custom Python scripts.',
  shortDescription: 'Transform data',
  configSubtitle: 'Configure data transformation rules, including mapping logic and Python script.',
  category: 'formatting',
  icon: 'ArrowLeftRight',
  defaultData: {
