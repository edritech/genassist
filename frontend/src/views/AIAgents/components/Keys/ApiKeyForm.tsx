    ...
    try {
      ...
      toast.error(
        `Failed to ${existingKey ? 'update' : 'create'} API key${
          error.status === 400 ? ': An API key with this name already exists' : ''
        }.`
      );
    } finally {
      setSaving(false);
      ...
      <DialogContent className="sm:max-w-2xl">
        ...
        >
          <DialogHeader>
            ...
            <DialogDescription>{existingKey ? 'Update the API key details' : 'Create a new API key'}</DialogDescription>
          </DialogHeader>
              ...
              <div className="space-y-2">
                ...
                <div className="relative flex flex-row items-center">
                  <Input
                    ...
                    value={isKeyVisible ? existingKey.key_val : maskInput(existingKey.key_val || '')}
                  />
