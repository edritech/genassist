    ...
    <div className="bg-gray-50 rounded-lg">
      <div className="flex items-center justify-between p-4">
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500">Enable vector database for semantic search</p>
          </div>
        </div>
        <Switch
      ...
      {vectorConfig.enabled && (
        <div className="p-4 pt-0 space-y-4">
          <div>
            <label className="block text-sm font-medium mb-2">Vector DB Type</label>
            <Select value={vectorConfig.type || ''} onValueChange={(value) => handleVectorChange('type', value)}>
