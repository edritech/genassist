...
import { isPasswordUpdateRequired, getAccessToken, logout, getAuthMe } from '@/services/auth';
          ...
          <div>
            ...
            {isForced && (
              <p className="text-sm text-muted-foreground mt-2">
                Your password needs to be updated before you can continue using the application.
              </p>
            )}
          </div>
        </div>
        <Card className="max-w-md mx-auto mt-8">
          <form onSubmit={handleSubmit} className="space-y-4 p-6">
            <div className="space-y-2">
              ...
              <Input type="text" value={username} disabled placeholder="Loading username..." />
            </div>
            <div className="space-y-2">
              <label className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">
                Current Password
