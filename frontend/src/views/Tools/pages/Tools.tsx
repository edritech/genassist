...
export default function Tools() {
  ...
  const [filterType, setFilterType] = useState<'all' | 'api' | 'function'>('all');
  ...
  const filteredTools = useMemo(() => {
    return tools.filter((tool) => {
      const matchesText = tool.name.toLowerCase().includes(searchQuery.toLowerCase());
            ...
            <div className="max-w-7xl mx-auto space-y-6">
              <header className="flex justify-between items-center">
                <div>
                  ...
                  <p className="text-muted-foreground">View and manage the tools</p>
                </div>
                <div className="flex items-center space-x-4">
                  ...
                  <Select value={filterType} onValueChange={(val) => setFilterType(val as 'all' | 'api' | 'function')}>
